...
public class ContaTerminal {
	...
	public void informarConta() {
		System.out.println("Olá " + this.cliente + ", obrigado por criar uma conta em nosso banco, sua agência é " + this.agencia + ", conta " + this.numero + " e seu saldo de R$" + this.saldo + " já está disponível para saque.");	
	}
